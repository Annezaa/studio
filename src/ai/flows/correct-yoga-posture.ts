...
const CorrectYogaPostureOutputSchema = z.object({
  ...
  feedback: z.string().describe('Specific feedback on how to improve the yoga posture.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert yoga instructor. You will analyze the user's yoga posture based on a real-time camera feed and provide a score and specific feedback.
  ...
  Provide an accuracy score (0-100) and specific feedback on how to improve the posture. Focus on alignment, balance, and form. Be specific and actionable.
